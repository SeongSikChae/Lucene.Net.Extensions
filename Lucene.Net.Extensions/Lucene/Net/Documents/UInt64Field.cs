...
{
	/// <summary>
	/// Field that indexes a <see cref="ulong"/> value for efficient filtering and sorting.
	/// Values are stored via order-preserving conversion to <see cref="long"/>.
	/// </summary>
	public sealed class UInt64Field : Field
	{
		/// <summary>
		/// Type for a <see cref="UInt64Field"/> that is indexed and stored.
		/// </summary>
		...
		/// <summary>
		/// Type for a <see cref="UInt64Field"/> that is indexed but not stored.
		/// </summary>
		...
		/// <summary>
		/// Creates a new <see cref="UInt64Field"/>.
		/// </summary>
